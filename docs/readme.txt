...
19/03/2025 - 1h
Atualização no gitHub para ter o modelo correto do projeto após ter que refazer do zero.
O modelo BPMN implementado é similar ao que tem em https://demo.bpmn.io/new.
O Download do diagrama já funciona

24/03/2025 - 30min
Reunião de ponto de situação com orientador:
- Foi indicado a utilização de um projeto no repositório do github para melhor orientação do que é preciso fazer
- Projeto criado e compartilhado com o orientador
- Foi analisado o que tinha feito e identificado onde seria preciso trabalhar
- Tarefa a realizar na semana: Como adicionar um novo icon a palete
- Tarefa a realizar na semana: Começar a escrever o relatório com frases indicando o que está sendo feito. (Usar template word)
